...
'ORIGINAL LINE: this.bciPrintCrosshair.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnPrintCrosshairItemClick);
			' 
			' bbiShowPrintPreview
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.bbiShowPrintPreview.ItemClick += new DevExpress.XtraBars.ItemClickEventHandler(this.OnShowPrintPreviewItemClick);
			' 
			' rpChartSettings
			' 
...
'ORIGINAL LINE: this.Load += new System.EventHandler(this.Form1_Load);
		...
		Private WithEvents bciPrintCrosshair As DevExpress.XtraBars.BarCheckItem
		Private WithEvents bbiShowPrintPreview As DevExpress.XtraBars.BarButtonItem
